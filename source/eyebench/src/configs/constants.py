...
class Fields(StrEnum):
    ...
    CLAIM = 'claim'
    CONTEXT = 'context'
    CLAIM_START_WORD_IDX = 'claim_start_word_idx'
    CLAIM_END_WORD_IDX = 'claim_end_word_idx'
    CONTEXT_START_WORD_IDX = 'context_start_word_idx'
    CONTEXT_END_WORD_IDX = 'context_end_word_idx'
