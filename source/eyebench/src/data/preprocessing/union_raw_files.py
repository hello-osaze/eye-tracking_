...
def combine_dataset(dataset_name: str) -> None:
    ...
    if dataset_name == 'MECOL2':
        ...
        library_dataset_name = DATASET_LIBRARY_ALIASES.get(dataset_name, dataset_name)
        dataset_def = pm.DatasetLibrary.get(library_dataset_name)
